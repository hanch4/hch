...
#if DEVICE_SLEEP
static sys_wakeup_handler gpio_wakeup_handler = NULL;
#endif
#if defined(GPIO_IRQ_DEBUG)
...
#if DEVICE_SLEEP
void gpio_irq_wakeup_handler_set(sys_wakeup_handler handler)
{
    gpio_wakeup_handler = handler;
}
#endif
