...
#else
extern int aes_128_cbc_encrypt(const u8 *key, const u8 *iv, u8 *data, size_t data_len);
#endif
...
int __must_check aes_128_cbc_decrypt(const u8 *key, const u8 *iv, u8 *data,
				     size_t data_len);
#else
extern int aes_128_cbc_decrypt(const u8 *key, const u8 *iv, u8 *data, size_t data_len);
#endif
