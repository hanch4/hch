...
#else /* MBEDTLS_DRBG_ALT */

#include "rda_trng_api.h"
int mbedtls_ctr_drbg_random( void *p_rng, unsigned char *output, unsigned int output_len )
{
    rda_trng_generator(output, output_len);
    return( 0 );
}
#endif /* MBEDTLS_DRBG_ALT */
